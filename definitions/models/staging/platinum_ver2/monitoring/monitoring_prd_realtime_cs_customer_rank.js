...
const model = new main.PlatinumModel(
    "monitoring_prd_realtime_cs_customer_rank",
    {
...
model.createIncremental(
    ["0h00","12h00", "platinum_staging", "monitoring_prd_realtime_cs"],
    {
...
model.assertUnique(
    ["0h00","12h00", "platinum_unique_assertion", "monitoring_prd_realtime_cs"],
    {
...
model.createMismatchAssertionView(
    ["platinum_staging_assertion_view", "monitoring_prd_realtime_cs"],
    {
...
model.assertMismatch(
    ["0h00","12h00", "platinum_staging_assertion", "monitoring_prd_realtime_cs"],
    {
        intervalCheckpoint: `INTERVAL 2 DAY`,
        maxRetry: 2,
