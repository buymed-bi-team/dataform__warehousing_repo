...
const model = new main.PlatinumModel(
    "marketplace_prd_order_v2_order_lead",
    {
...
model.createIncremental(
    ["platinum_00h00","platinum_12h00", "platinum_staging", "marketplace_prd_order-v2"],
    {
...
model.assertUnique(
    ["platinum_00h00","platinum_12h00", "platinum_unique_assertion", "marketplace_prd_order-v2"],
    {
...
model.assertMismatch(
    ["platinum_00h00","platinum_12h00", "platinum_staging_assertion", "marketplace_prd_order-v2"],
    {
        intervalCheckpoint: `INTERVAL 2 DAY`,
        maxRetry: 2,
