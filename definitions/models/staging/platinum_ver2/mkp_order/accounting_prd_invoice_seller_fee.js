...
const model = new main.PlatinumModel(
    "accounting_prd_invoice_seller_fee",
    {
...
model.createIncremental(
    ["0h00","12h00", "platinum_staging", "accounting_prd_invoice"],
    {
...
model.assertUnique(
    ["0h00","12h00", "platinum_unique_assertion", "accounting_prd_invoice"],
    {
...
model.createMismatchAssertionView(
    ["platinum_staging_assertion_view", "accounting_prd_invoice"],
    {
...
model.assertMismatch(
    ["0h00","12h00", "platinum_staging_assertion", "accounting_prd_invoice"],
    {
        intervalCheckpoint: `INTERVAL 2 DAY`,
        maxRetry: 2,
