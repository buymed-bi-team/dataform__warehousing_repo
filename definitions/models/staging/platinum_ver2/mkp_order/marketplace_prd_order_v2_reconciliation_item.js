...
const model = new main.PlatinumModel(
    "marketplace_prd_order_v2_reconciliation_item",
    {
        ...
        bigquery: {
            ...
            clusterBy: ["fee_type","sku_price_type", "reconcile_schedule_time_index","completed_debt_time"]
        }
    }
);
model.createIncremental(
    ["platinum_0h00","platinum_12h00", "platinum_staging", "marketplace_prd_order-v2","Finance/margin"],
    {
...
model.assertUnique(
    ["platinum_0h00","platinum_12h00", "platinum_unique_assertion", "marketplace_prd_order-v2","Finance/margin"],
    {
...
model.assertMismatch(
    ["platinum_0h00","platinum_12h00", "platinum_staging_assertion", "marketplace_prd_order-v2","Finance/margin"],
    {
        intervalCheckpoint: `INTERVAL 2 DAY`,
        maxRetry: 2,
