const model = new main.PlatinumModel(
    "seller_prd_purchasing_vendor_bill",
    {
        ...
        bigquery: {
            ...
            clusterBy: ["status","seller_code","vendor_code","issued_time"]
        }
    }
);
...
model.assertUnique(
    ["platinum_0h00","platinum_12h00", "platinum_unique_assertion", "seller_prd_purchasing"],
    {
        ...
        maxRetry: 2,
        dependencies: [{schema:"platinum_buymed_vn",name:"seller_prd_purchasing_vendor_bill"}]
    }
)
