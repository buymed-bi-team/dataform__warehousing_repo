const model = new main.PlatinumModel(
    "seller_prd_purchasing_purchase_order_item",
    {
        ...
        bigquery: {
            ...
            clusterBy: ["product_id","warehouse_code","vendor_code","po_code"]
        }
    }
);
...
model.assertUnique(
    ["platinum_0h00","platinum_12h00", "platinum_unique_assertion", "seller_prd_purchasing"],
    {
        ...
        maxRetry: 2,
        dependencies: [{schema:"platinum_buymed_vn",name:"seller_prd_purchasing_purchase_order_item"}]
    }
)
