...
const model = new main.PlatinumModel(
    "marketplace_prd_promotion_voucher_archived",
    {
        ...
        bigquery: {
            ...
            clusterBy: ["code","voucher_id","status","type"]
        }
    }
);
...
model.assertUnique(
    ["0h00","12h00", "platinum_unique_assertion", "marketplace_prd_promotion"],
    {
        ...
        maxRetry: 2,
        dependencies: [{schema:"platinum_buymed_vn",name:"marketplace_prd_promotion_voucher_archived"}]
    }
)
