...
const model = new main.PlatinumModel(
    "accounting_prd_invoice_order_invoice_item",
    {
...
// model.assertUnique(
//     ["0h00","12h00", "platinum_unique_assertion", "accounting_prd_core"],
//     {
...
//     ["0h00","12h00", "platinum_staging_assertion", "accounting_prd_core"],
//     {
//         intervalCheckpoint: `INTERVAL 2 DAY`,
//         maxRetry: 2,
