const model = new main.PlatinumModel(
    "platform_billing_prd_payment_payment_item",
    {
...
model.assertUnique(
    ["platinum_0h00","platinum_12h00", "platinum_unique_assertion", "platform_billing_prd_payment"],
    {
        ...
        maxRetry: 2,
        dependencies : [{schema:"platinum_buymed_vn_restricted",name:"platform_billing_prd_payment_payment_item"}]
    }
)
