...
const model = new main.PlatinumModel(
    "marketplace_prd_product_v2_pr_sku_item_pricing_level_log",
    {
...
model.createIncremental(
    ["0h00","12h00", "platinum_staging", "marketplace_prd_product-v2"],
    {
...
model.assertUnique(
    ["0h00","12h00", "platinum_unique_assertion", "marketplace_prd_product-v2"],
    {
...
model.assertMismatch(
    ["0h00","12h00", "platinum_staging_assertion", "marketplace_prd_product-v2"],
    {
        intervalCheckpoint: `INTERVAL 2 DAY`,
        maxRetry: 2,
