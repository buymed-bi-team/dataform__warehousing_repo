...
const model = new main.PlatinumModel(
    "marketplace_prd_product_v2_after_rebate_price_ticket",
    {
...
model.createIncremental(
    ["platinum_00h00", "platinum_staging", "marketplace_prd_product-v2"],
    {
...
model.assertUnique(
    ["platinum_00h00", "platinum_unique_assertion", "marketplace_prd_product-v2"],
    {
...
//     ["platinum_00h00", "platinum_staging_assertion", "marketplace_prd_product-v2"],
//     {
//         intervalCheckpoint: `INTERVAL 2 DAY`,
//         maxRetry: 2,
