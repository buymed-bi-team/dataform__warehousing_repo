...
const model = new main.PlatinumModel(
    "platform_accounting_prd_reconcile_CIRCA_COS_reconcile_item",
    {
...
model.createIncremental(
    ["platinum_00h00","platinum_12h00", "platinum_staging", "platform_accounting_prd_reconcile"],
    {
...
model.assertUnique(
    ["platinum_00h00","platinum_12h00", "platinum_unique_assertion", "platform_accounting_prd_reconcile"],
    {
...
model.assertMismatch(
    ["platinum_00h00","platinum_12h00", "platinum_staging_assertion", "platform_accounting_prd_reconcile"],
    {
        intervalCheckpoint: `INTERVAL 2 DAY`,
        maxRetry: 2,
