const model = new main.PlatinumModel(
    "warehouse_prd_inventory_inventory_historical",
    {
        ...
        bigquery: {
            ...
            clusterBy: ["warehouse_code","sku","day"]
        }
    }
);
...
model.assertUnique(
    ["platinum_0h00","platinum_12h00", "platinum_unique_assertion", "warehouse_prd_inventory"],
    {
        ...
        maxRetry: 2,
        dependencies : [{schema:"platinum_buymed_vn",name:"warehouse_prd_inventory_inventory_historical"}]
    }
)
