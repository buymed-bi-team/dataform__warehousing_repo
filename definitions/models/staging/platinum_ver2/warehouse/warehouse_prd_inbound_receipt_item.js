...
const model = new main.PlatinumModel(
    "warehouse_prd_inbound_receipt_item",
    {
...
model.createIncremental(
    ["platinum_00h00","platinum_12h00", "platinum_staging", "warehouse_prd_inbound"],
    {
...
model.assertUnique(
    ["platinum_00h00","platinum_12h00", "platinum_unique_assertion", "warehouse_prd_inbound"],
    {
...
model.createMismatchAssertionView(
    ["platinum_staging_assertion_view", "warehouse_prd_inbound"],
    {
        ...
        maxRetry: 2,
        dependencies : [{"schema":"platinum_buymed_vn","name":"warehouse_prd_inbound_receipt_item"}]
    }
)
model.assertMismatch(
    ["platinum_00h00","platinum_12h00", "platinum_staging_assertion", "warehouse_prd_inbound"],
    {
        intervalCheckpoint: `INTERVAL 2 DAY`,
        maxRetry: 2,
